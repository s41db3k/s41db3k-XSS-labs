...
<script>
if (localStorage.getItem("labs-s41db3k") === null) {
	 localStorage.setItem("labs-s41db3k", "labs-s41db3k");
}
</script>
  </head>
  <body>
...
<!-- partial -->
  ...
  <script>
if (localStorage.getItem("labs-s41db3k") !== null) {
		 document.getElementById("content").innerHTML = "<span>Current value of <b>labs-s41db3k</b> LocalStorage is: </span>" + localStorage.getItem("labs-s41db3k") + "";
}
</script>
</body>
</html>
